...
const MainHeading = ({openContact, tagline, socials, year}) => {
    ...
    return (
        <React.Fragment>
            <div tabIndex={0} role="heading" aria-label='top of page'></div>
             <motion.section className={`z5 flex justify__end ${c.mainheading__wrapper}`} 
                initial="hidden"
                animate={controls}  
                variants={container}
             > 
            ...
            <section ref={ref} className={c.mainheading__dummy}>

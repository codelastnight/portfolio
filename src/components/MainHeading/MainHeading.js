    ...
    return (
        <React.Fragment>
            ...
            <div className={`grid ${c.mainheading}`}>
                ...
                <div className="row2 col2 span6 flex flexgap align__center">
                    <h1 className={``}>I'm a</h1>
                    <div className={`relative width100 ${c.w20}`}>
                        <div className='z0 flex justify__center absolute width100' >
                            <Button className={`width100 ${c.button} ${c.margin1rem}`} color="#F8ACF0" height="2.5rem" radius="0.5rem" />
                        </div>
                        <svg className={` width100 ${c.svg}  ${c.margin1rem}`} viewBox="0 0 271 105" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg width="96" className={`${c.svg} `} height="37" viewBox="0 0 96 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="row3 col2 span6">
                    <div className={`relative`}>
                    <Button className={`absolute ${c.button} ${c.btn1}`}  height="3.5rem" radius="10rem" />
                ...
                <div className={`row5 col2__r end4__r ${c.paddingtop}`}>
